...
// probar con retirados
$route['retirados'] = 'retirados/index';
$route['retirados/exportar/(:any)'] = 'retirados/exportar/$1';
$route['retirados/agregar'] = 'retirados/agregar';
$route['retirados/modificar'] = 'retirados/modificar';
...
// Rutas para el controlador de prueba
$route['test'] = 'test/index';
$route['test/info'] = 'test/info';
$route['test/session'] = 'test/session_test';
$route['test/login'] = 'test/login_sim';
$route['test/redirect'] = 'test/redirect_test';
$route['test/base_url'] = 'test/base_url_test';
